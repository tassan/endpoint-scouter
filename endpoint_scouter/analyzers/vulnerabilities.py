...
class VulnerabilityAnalyzer:
    ...
    def _check_server_info_disclosure(
        self, response: requests.Response, result: ScanResult
    ) -> None:
        """
        Check for server information disclosure.
        ...
        try:
            ...
            for param, value in redirect_params.items():
                ...
                response = self.session.get(
                    redirect_url, timeout=timeout, allow_redirects=False
                )
    ...
    def _check_directory_listing(
        self, url: str, timeout: int, result: ScanResult
    ) -> None:
        """
